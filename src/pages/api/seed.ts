...
export default async function handler(
  ...
  await prisma.item.createMany({
    data: [
      ...
      },
      {
        ...
        description:
          "Boneless chicken breast pieces marinated with four different kind of  commenture and Indian spices for each piece and grilled in clay oven",
        price: "$16.99",
  ...
  await prisma.review.createMany({
    data: [
      {
        name: "Laith Harb",
        comment: "This place is amazing, it has some of the best dishes in the world. It is so so so good!!!",
        rating: 5,
        restaurant_id: vivaanId,
      ...
      {
        name: "Laith Harb",
        comment: "This food is so good! It is the fanciest thing I have ever seen in my short life",
        rating: 5,
        restaurant_id: bluRistoranteId,
        user_id: userLaith.id,
      },
      {
        name: "Laith Harb",
        comment: "Excellent food and service. Busy night, but everything was great! Highly recommend.",
        rating: 5,
        restaurant_id: elCatrinId,
        user_id: userLaith.id,
      },
      {
        name: "Laith Harb",
        comment: "Very nice place for a date night, the service was fast and friendly. The food was amazing.",
        rating: 4,
        restaurant_id: stelvioId,
        user_id: userLaith.id,
      },
      ...
      {
        name: "Laith Harb",
        comment: "As always, food was excellent. Waitress was friendly and prompt. We had just one problem in that our dessert order went rogue in the system and we waited ages for it to arrive.",
        rating: 5,
        restaurant_id: kamasutraIndianId,
        user_id: userLaith.id,
      },
      {
        name: "Laith Harb",
        comment: "Restaurant was loud and crowded. Food is not worth the price.",
        rating: 3,
        restaurant_id: eldoradoTacoId,
        user_id: userLaith.id,
      },
      {
        name: "Josh Allen",
        comment: "A Christmas lunch with clients served by a friendly server with a good wine selection everyone enjoyed the appetizers and meals",
        rating: 4,
        restaurant_id: vivaanId,
        user_id: userJosh.id,
      },
      {
        name: "Josh Allen",
        comment: "The food was very tasty, the price is a little high so a place to go only for special occasions",
        rating: 5,
      ...
      {
        name: "Josh Allen",
        comment: "Had a great time at Chops. Our server Dane was super friendly. Dinner was delicious as always.",
        rating: 3,
        restaurant_id: curryishTavernId,
        user_id: userJosh.id,
      },
      {
        name: "Josh Allen",
        comment: "The service was poor as we had to wait a long time for our food. There were some issues but were dealt with in a proper manner.",
        rating: 3,
        restaurant_id: adrakYorkvilleId,
        user_id: userJosh.id,
      },
      ...
      {
        name: "Josh Allen",
        comment: "Great food, great staff. You can’t ask for much more from a restaurant.",
        rating: 5,
        restaurant_id: bluRistoranteId,
        user_id: userJosh.id,
      },
      {
        name: "LeBron James",
        comment: "Wonderful service! Delicious food! Comfortable seating and luxurious atmosphere.",
        rating: 5,
        restaurant_id: RamaKrishnaId,
      ...
      {
        name: "LeBron James",
        comment: "Prime rib and filet were made spot on. Vegetable sides were made well as was the shrimp and scallops.",
        rating: 4,
        restaurant_id: lastTrainToDelhiId,
        user_id: userLebron.id,
      },
      {
        name: "LeBron James",
        comment: "This visit was with a friend who had never been here before. She loved it as much as I do. She said it will be our new go to place!",
        rating: 4,
        restaurant_id: curryishTavernId,
        user_id: userLebron.id,
      },
      {
        name: "LeBron James",
        comment: "Had a full 3 course meal in the mid afternoon and every aspect of it was great. Server was named Brittany I believe and she was simply excellent.",
        rating: 5,
        restaurant_id: pukkaId,
        user_id: userLebron.id,
      },
      ...
      {
        name: "LeBron James",
        comment: "First time, and not the last. Very welcoming. The food was deliscious and service very good. Highly recommend.",
        rating: 4,
        restaurant_id: eldoradoTacoId,
        user_id: userLebron.id,
      },
      {
        ...
        comment: "Enjoyed our drinks, dinner and dessert. Great service and ambience.",
        rating: 5,
        restaurant_id: mariachisId,
      ...
      {
        name: "Cassidy Mancher",
        comment: "The food was absolutely on point, we had such a great experience and our server was top notch. ",
        rating: 4,
        restaurant_id: stelvioId,
        user_id: userCassidy.id,
      },
      {
        name: "Cassidy Mancher",
        comment: "The steaks were 'Melt In Your Mouth'!!! Nigel, our waiter was amazing!! Great experience overall!",
        rating: 5,
        restaurant_id: coconutLagoonId,
        user_id: userCassidy.id,
      },
      {
        name: "Cassidy Mancher",
        comment: "It was really great! Just temperature wise it was really chilly. A little mixup at the end with desserts also but overall we really enjoyed the evening",
        rating: 4,
        restaurant_id: bluRistoranteId,
        user_id: userCassidy.id,
      },
      {
        name: "Cassidy Mancher",
        comment: "Food was served cold. Major No No. Fantastic Dessert. Service was good. Heavy Rock music should be toned down. Price vs Quality… not great.",
        rating: 3,
        restaurant_id: laBartolaId,
        user_id: userCassidy.id,
      },
      {
        name: "Cassidy Mancher",
        comment: "Fantastic food and excellent selection. Everything was fresh - and the scones were still warm!",
        rating: 4,
        restaurant_id: eldoradoTacoId,
        user_id: userCassidy.id,
      },
